...
const menuItems = [
  { id: 'home', label: '首頁', icon: Home, path: '/', requireLogin: false },
  { id: 'leaderboard', label: '排行榜', icon: Trophy, path: '/leaderboard', requireLogin: false },
  { id: 'create', label: '創建問題', icon: PlusCircle, path: '/create', requireLogin: true },
  { id: 'quests', label: '任務', icon: CheckSquare, path: '/quests', requireLogin: true, badge: 2 },
  { id: 'notifications', label: '通知', icon: Bell, path: '/notifications', requireLogin: true, badge: 5 },
  { id: 'referrals', label: '邀請好友', icon: Users, path: '/referrals', requireLogin: true },
  { id: 'profile', label: '我的', icon: User, path: '/profile', requireLogin: true },
];

export function Sidebar({ isOpen, onClose, isLoggedIn, user, onLogin, onLogout }: SidebarProps) {
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-1 text-sm">
                  ...
                  <span className="font-bold text-amber-600">{user.totalAssets.toLocaleString()}</span>
                </div>
              </div>
            </div>
          </div>
